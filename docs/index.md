<h1 align="center" style="margin-bottom:0;">
  <strong><code>16Sguild</code> : Guild-based 16S-rRNA sequencing analysis pipeline</strong>
</h1>

<p align="center" style="margin-bottom:0;">
<img width="500" height="600" class="center" alt="16Sguild Logo" src="assets/16Sguild_long.png" />
</p>
...
<p align="center" style="font-size:22px;">
  <strong>
    A Nextflow workflow for guild-based 16S-rRNA sequencing analysis such as introduced by 
...
<h2 align="center"> Brief Parameter Descriptions </h2>
...
| `linkage_table`  | Table output from [16Sguild database](https://biostats-dashboard.kumc.edu/16SguildDB/) assigning UUIDs to ASVs (experiment-dependent)|
...
- `docs/` - Documentation for `16Sguild` pipeline [website](https://github.com/rachelgriffard/16Sguild/tree/main/docs/index.md)
...
- `results/visualizations` contains files that can be used on the [QIIME1 viewing platform](https://view.qiime2.org/).
...
- Results files are symlinked by default. Users can set publish.mode = 'copy' to change this to copy, although this is not suggested unless necessary.
---
...
- [Full Documentation]()
- [Parameter descriptions](parameters.md)
